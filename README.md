...
- Low Poly 3D 虚拟办公室：使用 Three.js、@react-three/fiber、@react-three/drei 渲染 3D 场景。
...
- Agent 小角色：已占用座位显示由 sphere / capsule / box 组成的小角色，并显示工作状态点与状态气泡。
- 3D 家具：会议桌、沙发、绿植、打印机、门、接待台、饮水机、小茶几均用基础几何体组合绘制。
- 查看模式 / 编辑模式切换：默认进入查看模式，编辑模式下支持地面平面拖拽、新增、编辑和删除对象。
