...
const groups: { title: string; hint: string; assets: AssetTemplate[] }[] = [
  ...
  {
    title: '装饰控件',
    hint: '用于补充 voxel 小世界氛围的轻量装饰层',
    assets: [
      { id: 'rug', name: '地毯', description: '低矮色块区域', kind: 'decoration', defaults: { label: '地毯', width: 120, height: 72, color: '#ffd76a', decorationType: 'rug', rotation: 0 } },
      { id: 'lamp', name: '氛围灯', description: '发光小灯柱', kind: 'decoration', defaults: { label: '氛围灯', width: 44, height: 44, color: '#bfe7ff', decorationType: 'lamp', rotation: 0 } },
      { id: 'screen', name: '状态屏', description: '团队信息屏', kind: 'decoration', defaults: { label: '状态屏', width: 92, height: 56, color: '#8fe1ff', decorationType: 'screen', rotation: 0 } },
      { id: 'locker', name: '储物柜', description: '方块柜体', kind: 'decoration', defaults: { label: '储物柜', width: 84, height: 52, color: '#9fb4cc', decorationType: 'locker', rotation: 0 } },
      { id: 'crate', name: '物料箱', description: '体素方箱', kind: 'decoration', defaults: { label: '物料箱', width: 60, height: 54, color: '#d7b48b', decorationType: 'crate', rotation: 0 } },
    ],
  },
  {
    title: '员工工位',
